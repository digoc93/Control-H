...
ControlH3.prototype.getHoursInDateRange = function (info, callback){
	...
	var init_date = new Date(initDateUTC + info.diff);
	init_date.setMinutes(init_date.getMinutes() + info.diff);	

	var split_final = info.finalDate.split(".");
	var endDateUTC = Date.UTC(split_final[2],split_final[0]-1,split_final[1]);
	var end_date = new Date(endDateUTC + info.diff);
	end_date.setDate(end_date.getDate()+1);
	end_date.setMinutes(end_date.getMinutes() + info.diff);
