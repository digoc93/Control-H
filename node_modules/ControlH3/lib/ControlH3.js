...
ControlH3.prototype.addProject = function (info, callback){
	...
	Project.addProject(info,function(error,response){
		if(error){
			...
			Backlog.addBacklog(dataBacklog, function(err, result){
...
ControlH3.prototype.addBacklog = function(data, callback){
	var info = {
...
ControlH3.prototype.getBacklogByProjectIdAndType = function(idProject, type,  callback){
	Backlog.getBacklogByProjectAndType(idProject, type, function(error, response)){
		if(error){
			return callback(error, null);
		}else if(!response){
